...
$(function() {
    ...
    // ============================================================== 
    $.ajax({
        url:'http://88.198.106.121/api_gsim/v1/dashboard',
        headers:{'X-Auth-Token': $.cookie("token")}
    }).then((res)=>{
        var data_length = res.payload.daily_items.length
        var arr = []
        var sms = []
        var rec = []
        ...
        for (var i = 0; i < data_length; i++) {
            sms.push(res.payload.daily_items[i].sms_count/1000)
            rec.push(res.payload.daily_items[i].rec_count/1000)
        }
