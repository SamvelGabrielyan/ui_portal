	        ...
	        <div class="card">
	            <div class="card-body">
	                <div class="container pb-3">
						<h3>Annual Usage DID purchase</h3>
						<div class="row mt-2">
							<div class="col-xs-8 col-sm-6 col-md-6">
								<span class="select-span">How many numbers do you need?</span>
							</div>
							<div class="col-xs-4 col-sm-6 col-md-6">
								<input @input="Decimal()" v-model="FirstInput" min=1 class="form-control" type="text" step="1">
							</div>
						</div>
						<div class = "row mt-2">
							<div class="col-xs-8 col-sm-6 col-md-6">
							...
							<div class="col-xs-4 col-sm-6 col-md-6">
								<input list="browsers" class="form-control" :value="'United States'">
						...
						<div class="row mt-2">
							<div class="col-xs-8 col-sm-6 col-md-6">
								<span class="select-span">How many years do you need it for ?</span>
							</div>
							<div class="col-xs-4 col-sm-6 col-md-6">
								<input @input="Decimal1()" v-model="FirstInput1" min=1 class="form-control" type="text">
							</div>
						</div>
					</div>
					...
					<!--<div class="row">-->
					    ...
					    <!--</div>-->
					    <!--<div class="col">-->
					      	<!--&lt;!&ndash;<img src="../assets/images/PayPal.png" style="width:200px;">&ndash;&gt;-->
					      	<!--&lt;!&ndash;<img src="../assets/images/Bitcoin_logo.png" style="width:200px;">&ndash;&gt;-->
					...
					<div class="row">
						<div class="row m-auto">
							<div id="paypal-buttons" style="width:200px;"></div>
						</div>
					</div>
				</div>
			</div>
    ...
    export default{
        ...
        methods:{
            ...
            Decimal1:function(){
                if (this.FirstInput1 != '') {
                    var regex = /[0-9]/;
                    if (!this.FirstInput1[this.FirstInput1.length - 1].match(regex)) {
                        this.FirstInput1 = this.FirstInput1.slice(0, -1)
                    }
                    else {
                        return
                    }
